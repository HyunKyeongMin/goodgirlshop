...
<%@ include file="homenav.jsp" %>
	...
	<div id="member">
		<span id="member_n"><strong>회원수정</strong></span>
	</div>
	<hr>
	<form action="MemberUpdate"  method="POST"  id="frm_update" name="frm_update">
	<div class="boardWrite">
 	<%-- <C:forEach items="${list}" var="mImpo">  --%>
	 	<table>
			<tr>
				<th>
					아이디
				...
				<td>
				<input class="member_box" type="text" value="${sessionScope.loginUser.shopid}" id = "uid" name="uid" class="input_login" size="20" maxlength="15" placeholder="ID" readonly/>
				(아이디 수정 불가)<br>
			<!-- 	<button class="button_b">아이디중복확인▶</button> -->
				</td>
			</tr>
			<br>
			...
			<tr>
				...
				<td>
				<input class="member_box" type="password"  value="${sessionScope.loginUser.shoppw}" id = "upw" name="upw" class="input_pw" size="20" maxlength="15" placeholder="PW">
			...
			<tr>
				...
				<td>
				<input class="member_box" type="password" id = "urepw" name="urepw" class="input_pw_check" size="20" maxlength="15" placeholder="PW2">
...
<!-- 			<tr>
			...
			<tr>
				...
				<td>
				<input class="member_box" type="text"  value="${sessionScope.loginUser.shopname}" id = "uname" name="uname"  class="input_name" size="20" maxlength="15" placeholder="이름">	
				...
				<td>				
				<input type="text" id="sample6_postcode" value="${sessionScope.loginUser.shopzipcode}"  class="member_box" name="uzipcode" size="10" maxlength="10" placeholder="우편번호" readonly/>
				...
				<input type="text" id="sample6_address" value="${sessionScope.loginUser.shopaddr1}" class="member_box" name="uaddr1" size="40" maxlength="35" placeholder="주소" readonly/>
				<input type="text" id="sample6_address2" value="${sessionScope.loginUser.shopaddr2}" class="member_box" name="uaddr2" size="40" maxlength="35" placeholder="상세주소">
			...
			<tr>
				...
				<input class="member_box" type="text" value="${sessionScope.loginUser.shopphone}" id = "uphone" name="uphone" class="input_phone" size="40" maxlength="25" placeholder="">
			...
			<tr>
				...
				<td>
				<input class="member_box" type="text" value="${sessionScope.loginUser.shopemail}" id = "uemail" name="uemail" class="input_addr1" size="50" maxlength="30" placeholder="">
...
<%-- 	</C:forEach>  --%>
	...
	<hr>
	<div class="button">
	<a href="#" id ="btn_member_a"><span class="button_s">회원수정</span></a>
